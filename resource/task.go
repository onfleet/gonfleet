...
type Task struct {
	...
	DelayTime                *float64                 `json:"delayTime,omitempty"`
...
type TaskCompletionDetails struct {
	...
	FirstLocation          DestinationLocation   `json:"firstLocation,omitempty"`
	LastLocation           DestinationLocation   `json:"lastLocation,omitempty"`
	Notes                  string                `json:"notes,omitempty"`
